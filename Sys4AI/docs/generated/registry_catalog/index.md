...
| registries/completion_receipt_registry.csv | SRC-REG-COMPLETION-RECEIPTS | completion_receipt_registry | controlled | 48 | control_loop |
...
| registries/control_record_registry.csv | SRC-REG-CONTROL-RECORDS | control_record_registry | controlled | 241 | implementation_initialization |
...
| registries/director_decision_registry.csv | SRC-REG-DIRECTOR-DECISIONS | director_decision_registry | controlled | 34 | control_loop |
...
| registries/handoff_registry.csv | SRC-REG-HANDOFFS | handoff_registry | controlled | 48 | control_loop |
| registries/local_evidence_execution_registry.csv | SRC-REG-LOCAL-EVIDENCE-EXECUTION | local_evidence_execution_registry | controlled | 32 | verification_engineer |
| registries/memory_preflight_receipt_registry.csv | SRC-REG-MEMORY-PREFLIGHT-RECEIPTS | memory_preflight_receipt_registry | controlled | 48 | control_loop |
| registries/object_relationship_registry.csv | SRC-REG-OBJECT-RELATIONSHIPS | object_relationship_registry | controlled | 367 | source_first_memory |
...
| registries/source_registry.csv | SRC-REG-SOURCES | source_registry | controlled | 547 | implementation_initialization |
