...
| registries/completion_receipt_registry.csv | SRC-REG-COMPLETION-RECEIPTS | completion_receipt_registry | controlled | 33 | control_loop |
...
| registries/control_record_registry.csv | SRC-REG-CONTROL-RECORDS | control_record_registry | controlled | 173 | implementation_initialization |
...
| registries/handoff_registry.csv | SRC-REG-HANDOFFS | handoff_registry | controlled | 33 | control_loop |
| registries/memory_preflight_receipt_registry.csv | SRC-REG-MEMORY-PREFLIGHT-RECEIPTS | memory_preflight_receipt_registry | controlled | 33 | control_loop |
| registries/object_relationship_registry.csv | SRC-REG-OBJECT-RELATIONSHIPS | object_relationship_registry | controlled | 190 | source_first_memory |
...
| registries/source_registry.csv | SRC-REG-SOURCES | source_registry | controlled | 432 | implementation_initialization |
