...
| registries/completion_receipt_registry.csv | SRC-REG-COMPLETION-RECEIPTS | completion_receipt_registry | controlled | 46 | control_loop |
...
| registries/control_record_registry.csv | SRC-REG-CONTROL-RECORDS | control_record_registry | controlled | 231 | implementation_initialization |
...
| registries/director_decision_registry.csv | SRC-REG-DIRECTOR-DECISIONS | director_decision_registry | controlled | 32 | control_loop |
...
| registries/handoff_registry.csv | SRC-REG-HANDOFFS | handoff_registry | controlled | 46 | control_loop |
| registries/local_evidence_execution_registry.csv | SRC-REG-LOCAL-EVIDENCE-EXECUTION | local_evidence_execution_registry | controlled | 11 | verification_engineer |
| registries/memory_preflight_receipt_registry.csv | SRC-REG-MEMORY-PREFLIGHT-RECEIPTS | memory_preflight_receipt_registry | controlled | 46 | control_loop |
| registries/object_relationship_registry.csv | SRC-REG-OBJECT-RELATIONSHIPS | object_relationship_registry | controlled | 348 | source_first_memory |
...
| registries/source_registry.csv | SRC-REG-SOURCES | source_registry | controlled | 527 | implementation_initialization |
...
| registries/validation_contract_registry.csv | SRC-REG-VALIDATION-CONTRACTS | validation_contract_registry | controlled | 48 | implementation_initialization |
