...
| --- | --- | --- | --- | --- | --- |
| registries/agentjob_registry.csv | SRC-REG-AGENTJOBS | agentjob_registry | controlled | 24 | control_loop |
...
| registries/completion_receipt_registry.csv | SRC-REG-COMPLETION-RECEIPTS | completion_receipt_registry | controlled | 19 | control_loop |
...
| registries/control_record_registry.csv | SRC-REG-CONTROL-RECORDS | control_record_registry | controlled | 108 | implementation_initialization |
...
| registries/director_decision_registry.csv | SRC-REG-DIRECTOR-DECISIONS | director_decision_registry | controlled | 17 | control_loop |
...
| registries/handoff_registry.csv | SRC-REG-HANDOFFS | handoff_registry | controlled | 19 | control_loop |
| registries/memory_preflight_receipt_registry.csv | SRC-REG-MEMORY-PREFLIGHT-RECEIPTS | memory_preflight_receipt_registry | controlled | 19 | control_loop |
...
| registries/source_registry.csv | SRC-REG-SOURCES | source_registry | controlled | 296 | implementation_initialization |
