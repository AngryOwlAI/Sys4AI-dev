...
|---|---|---|---|---|
| domain-grilling-with-docs | required | when brownfield evidence needs domain stress testing | target_system_instance | implementation_plans/sys-for-ai-dev_all_recommendations_implementation_plan.md |
