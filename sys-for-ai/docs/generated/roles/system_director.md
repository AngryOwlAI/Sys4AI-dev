...
| domain-pack-router | optional | when core versus domain-pack boundary is disputed | development_system;framework_product;target_system_template;target_system_instance | implementation_plans/sys-for-ai-dev_all_recommendations_implementation_plan.md |
