...
| --- | --- | --- | --- | --- | --- |
| registries/agentjob_registry.csv | SRC-REG-AGENTJOBS | agentjob_registry | controlled | 16 | control_loop |
...
| registries/completion_receipt_registry.csv | SRC-REG-COMPLETION-RECEIPTS | completion_receipt_registry | controlled | 12 | control_loop |
...
| registries/control_record_registry.csv | SRC-REG-CONTROL-RECORDS | control_record_registry | controlled | 72 | implementation_initialization |
...
| registries/director_decision_registry.csv | SRC-REG-DIRECTOR-DECISIONS | director_decision_registry | controlled | 10 | control_loop |
...
| registries/handoff_registry.csv | SRC-REG-HANDOFFS | handoff_registry | controlled | 12 | control_loop |
| registries/memory_preflight_receipt_registry.csv | SRC-REG-MEMORY-PREFLIGHT-RECEIPTS | memory_preflight_receipt_registry | controlled | 12 | control_loop |
...
| registries/source_registry.csv | SRC-REG-SOURCES | source_registry | controlled | 244 | implementation_initialization |
