...
Adapter shell for the core `sys-for-ai` skill `system-definition-interview`.

## Source

- Repository: `https://github.com/AngryOwlAI/ai-skills-for-sys`
- Path: `skills/system-definition-interview`

## Purpose

Establish or reconstruct system intent, boundary, stakeholders, scenarios, candidate requirements, architecture drivers, interfaces, evidence, and V&V seeds before downstream PRD or formal systems-document generation.
