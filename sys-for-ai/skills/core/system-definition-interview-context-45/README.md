...
Use `skills/core/codex-usage-metrics/scripts/collect_usage_metrics.py` for local Codex app context metrics. If the script is missing, fails, or cannot report usable context-left data, write `temp_prd.md` and stop.
